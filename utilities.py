...
def connectToRobot(portNo):
    ...
    try:
        ...
        print("Not Connected To Serial Device ")
        pass
 
#Use the serial port to send the data in this format: $00000, the "$" symbol represents the beginning of the command, used by the serial device to identify where the command starts and finishes.
